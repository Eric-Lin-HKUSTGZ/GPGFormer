import inspect
# chumpy (required by legacy MANO *.pkl files) uses inspect.getargspec which was removed in Python 3.11+.
# Patch it for compatibility.
if not hasattr(inspect, "getargspec"):
    inspect.getargspec = inspect.getfullargspec  # type: ignore[attr-defined]

import numpy as _np
# chumpy also expects legacy numpy aliases removed in numpy>=2.0.
_legacy_aliases = {
    "bool": bool,
    "int": int,
    "float": float,
...
for _k, _v in _legacy_aliases.items():
